...
public class SceneGenerator {    
    ...
    public Scene createScene() {
      ...
      int he = 20;
      final MediaView mediaView = new MediaView(players.get(1));
      ImageView playing = new ImageView(new Image("play.png"));
      ImageView pauser = new ImageView(new Image("pause.png"));
